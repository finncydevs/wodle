...
function getKeyClass(key) {
  ...
  return {
    ...
    "bg-yellow-500 text-white": status === "misplaced",
    "bg-gray-700 text-white": status === "wrong",
    "bg-gray-800 text-white": !status,
  }
}
</script>
    ...
    >
      <button
        ...
        :class="[
          ...
          'hover:brightness-110 active:scale-95 text-white flex items-center justify-center',
          getKeyClass(key),
          key === 'ENTER' || key === '←'
